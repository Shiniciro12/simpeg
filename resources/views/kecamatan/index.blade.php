  ...
  <div class="row">
    <div class="col-md-11 mt-2 mx-auto">
      <div class="text-center my-4">
        ...
        <a href="/kecamatan/add" class="btn btn-success p-2 shadow"><i class="bi bi-plus"></i></a>
      </div>
      <br>
        ...
        <div class="table-responsive">
          <table class="table table-hover table-striped shadow">
            ...
            <tbody>
              ...
              <tr>
                <td scope="row">
                  <a href="/kecamatan/update/{{ $row["kecamatan_id"] }}" class="btn btn-warning p-2 shadow"><i class="bi bi-pencil-square"></i></a>

        ...
        <form action="/pangkat/add" method="post" enctype="multipart/form-data">
            ...
            <div id="data-diri">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('pangkat') is-invalid @enderror" value="{{old('pangkat')}}" id="pangkat" aria-describedby="pangkat" name="pangkat">
                    @error('pangkat')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('golongan') is-invalid @enderror" value="{{old('golongan')}}" id="golongan" aria-describedby="golongan" name="golongan">
                        @error('golongan')

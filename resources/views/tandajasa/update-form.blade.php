        ...
        <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{$rowsTandaJasa->nama}}" id="nama" aria-describedby="nama">
                            @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="no_sk" class="form-control @error('no_sk') is-invalid @enderror" value="{{$rowsTandaJasa->no_sk}}" id="no_sk" aria-describedby="no_sk">
                            @error('no_sk')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tgl_sk" class="form-control @error('tgl_sk') is-invalid @enderror" value="{{$rowsTandaJasa->tgl_sk}}" id="tgl_sk" aria-describedby="tgl_sk">
                        @error('tgl_sk')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="tahun" class="form-control @error('tahun') is-invalid @enderror" value="{{$rowsTandaJasa->tahun}}" id="tahun" aria-describedby="tahun" placeholder="2001">
                            @error('tahun')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="asal_perolehan" class="form-control @error('asal_perolehan') is-invalid @enderror" value="{{$rowsTandaJasa->asal_perolehan}}" id="asal_perolehan" aria-describedby="asal_perolehan">

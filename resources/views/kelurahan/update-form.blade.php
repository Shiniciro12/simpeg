            ...
            <form action="/kelurahan/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_kelurahan') is-invalid @enderror"
                        value="{{old('nama_kelurahan', $data['nama_kelurahan'])}}" id="nama_kelurahan" aria-describedby="nama_kelurahan" name="nama_kelurahan">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('kode_pos') is-invalid @enderror"
                        value="{{old('kode_pos', $data['kode_pos'])}}" id="kode_pos" aria-describedby="kode_pos" name="kode_pos">
                    @error('kode_pos')

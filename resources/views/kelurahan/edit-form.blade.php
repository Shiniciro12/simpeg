...
<div class="container">
    <div class="row">
        <div class="col-md-10">
            <h3>Kelurahan</h3>
            <form action="/kelurahan/{{ $data['kelurahan_id'] }}" method="post">
                @method('patch')
                @csrf
                <div class="mt-2 mb-4"><span class="text-danger">*</span> Wajib diisi</div>
                <div class="mb-3">
                    <label for="nama_kelurahan" class="form-label">Nama Kelurahan <span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control @error('nama_kelurahan') is-invalid @enderror"
                        value="{{old('nama_kelurahan', $data['nama_kelurahan'])}}" id="nama_kelurahan"
                        aria-describedby="nama_kelurahan" name="nama_kelurahan">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('kode_pos') is-invalid @enderror"
                        value="{{old('kode_pos', $data['kode_pos'])}}" id="kode_pos" aria-describedby="kode_pos"
                        name="kode_pos">
                    @error('kode_pos')

            ...
            <form action="/diklat/update" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('status') is-invalid @enderror" name="status" aria-label="status"
                        ...
                        <option value="Diklat Struktural" <?php if ($rowsDiklat['status']=='Diklat Struktural' ) {
                            echo "SELECTED" ; } ?>>Diklat Struktural</option>
                        <option value="Diklat Fungsional" <?php if ($rowsDiklat['status']=='Diklat Fungsional' ) {
                            echo "SELECTED" ; } ?>>Diklat Fungsional</option>
                        <option value="Diklat Teknis" <?php if ($rowsDiklat['status']=='Diklat Teknis' ) {
                            echo "SELECTED" ; } ?>>Diklat Teknis</option>
                    </select>
                    @error('status')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                        value="{{old('nama',$rowsDiklat->nama)}}" id="nama" aria-describedby="nama" name="nama">
                    @error('nama')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tempat" class="form-control @error('tempat') is-invalid @enderror"
                        value="{{old('tempat', $rowsDiklat->tempat)}}" id="tempat" aria-describedby="tempat"
                        name="tempat">
                    @error('tempat')
                ...
                <div class="mb-3">
                    <label for="penyelenggara" class="form-label">Penyelenggara <span
                            class="text-danger">*</span></label>
                    <input type="text" name="penyelenggara"
                        class="form-control @error('penyelenggara') is-invalid @enderror"
                        value="{{old('penyelenggara', $rowsDiklat->penyelenggara)}}" id="penyelenggara"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="angka" class="form-control @error('angka') is-invalid @enderror"
                        value="{{old('angka',$rowsDiklat->angka)}}" id="angka" aria-describedby="angka" name="angka">
                    @error('angka')
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="tgl_mulai" class="form-control @error('tgl_mulai') is-invalid @enderror"
                        value="{{old('tgl_mulai',$rowsDiklat->tgl_mulai)}}" id="tgl_mulai" aria-describedby="tgl_mulai"
                        name="tgl_mulai">
                    @error('tgl_mulai')
        ...
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <input type="date" name="tgl_selesai" class="form-control @error('tgl_selesai') is-invalid @enderror"
                    value="{{old('tgl_selesai',$rowsDiklat->tgl_selesai)}}" id="tgl_selesai"
            ...
            <div class="mb-3">
                ...
                <input type="number" name="jam" class="form-control @error('jam') is-invalid @enderror"
                    value="{{old('jam',$rowsDiklat->jam)}}" id="jam" aria-describedby="jam" name="jam">
                @error('jam')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="no_sttp" class="form-control @error('no_sttp') is-invalid @enderror"
                    value="{{old('no_sttp',$rowsDiklat->no_sttp)}}" id="no_sttp" aria-describedby="no_sttp"
                    name="no_sttp">
                @error('no_sttp')
            ...
            <div class="mb-3">
                ...
                <input type="date" name="tgl_sttp" class="form-control @error('tgl_sttp') is-invalid @enderror"
                    value="{{old('tgl_sttp',$rowsDiklat->tgl_sttp)}}" id="tgl_sttp" aria-describedby="tgl_sttp"
                    name="tgl_sttp">
                @error('tgl_sttp')

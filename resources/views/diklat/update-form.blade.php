    ...
    <div class="row">
        <div class="col-md-6">
            <form action="/diklat/update" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{$rowsDiklat->nama}}" id="nama" aria-describedby="nama" name="nama">
                    @error('nama')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tempat" class="form-control @error('tempat') is-invalid @enderror" value="{{$rowsDiklat->tempat}}" id="tempat" aria-describedby="tempat" name="tempat">
                    @error('tempat')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="penyelenggara" class="form-control @error('penyelenggara') is-invalid @enderror" value="{{$rowsDiklat->penyelenggara}}" id="penyelenggara" aria-describedby="penyelenggara" name="penyelenggara">
                    @error('penyelenggara')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="angka" class="form-control @error('angka') is-invalid @enderror" value="{{$rowsDiklat->angka}}" id="angka" aria-describedby="angka" name="angka">
                    @error('angka')
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="tgl_mulai" class="form-control @error('tgl_mulai') is-invalid @enderror" value="{{$rowsDiklat->tgl_mulai}}" id="tgl_mulai" aria-describedby="tgl_mulai" name="tgl_mulai">
                    @error('tgl_mulai')
        ...
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <input type="date" name="tgl_selesai" class="form-control @error('tgl_selesai') is-invalid @enderror" value="{{$rowsDiklat->tgl_selesai}}" id="tgl_selesai" aria-describedby="tgl_selesai" name="tgl_selesai">
                @error('tgl_selesai')
            ...
            <div class="mb-3">
                ...
                <input type="number" name="jam" class="form-control @error('jam') is-invalid @enderror" value="{{$rowsDiklat->jam}}" id="jam" aria-describedby="jam" name="jam">
                @error('jam')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="no_sttp" class="form-control @error('no_sttp') is-invalid @enderror" value="{{$rowsDiklat->no_sttp}}" id="no_sttp" aria-describedby="no_sttp" name="no_sttp">
                @error('no_sttp')
            ...
            <div class="mb-3">
                ...
                <input type="date" name="tgl_sttp" class="form-control @error('tgl_sttp') is-invalid @enderror" value="{{$rowsDiklat->tgl_sttp}}" id="tgl_sttp" aria-describedby="tgl_sttp" name="tgl_sttp">
                @error('tgl_sttp')

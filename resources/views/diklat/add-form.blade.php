    ...
    <div class="row">
        <div class="col-md-6">
            <form action="/diklat/add" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="status" required class="form-label">Jenis Diklat <span
                            class="text-danger">*</span></label>
                    <select class="form-select @error('status') is-invalid @enderror" value="{{old('status')}}"
                        name="status" aria-label="status" id="status">
                        <option value="">Pilih Riwayat Diklat</option>
                        <option {{old('status')=='Diklat Struktural' ? 'selected' : '' }} value="Diklat Struktural">
                            Diklat Struktural
                        </option>
                        <option {{old('status')=='Diklat Fungsional' ? 'selected' : '' }} value="Diklat Fungsional">
                            Diklat Fungsional
                        </option>
                        <option {{old('status')=='Diklat Teknis' ? 'selected' : '' }} value="Diklat Teknis">Diklat
                            Teknis
                        </option>
                    </select>
                    @error('status')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="penyelenggara"
                        ...
                        value="{{old('penyelenggara')}}" id="penyelenggara" aria-describedby="penyelenggara"
                        name="penyelenggara">
                    @error('penyelenggara')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="angka" class="form-control @error('angka') is-invalid @enderror"
                        value="{{old('angka')}}" id="angka" aria-describedby="angka" name="angka">
                    @error('angka')
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="tgl_mulai" class="form-control @error('tgl_mulai') is-invalid @enderror"
                        value="{{old('tgl_mulai')}}" id="tgl_mulai" aria-describedby="tgl_mulai" name="tgl_mulai">
                    @error('tgl_mulai')
        ...
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <input type="date" name="tgl_selesai" class="form-control @error('tgl_selesai') is-invalid @enderror"
                    value="{{old('tgl_selesai')}}" id="tgl_selesai" aria-describedby="tgl_selesai" name="tgl_selesai">
                @error('tgl_selesai')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="no_sttp" class="form-control @error('no_sttp') is-invalid @enderror"
                    value="{{old('no_sttp')}}" id="no_sttp" aria-describedby="no_sttp" name="no_sttp">
                @error('no_sttp')
            ...
            <div class="mb-3">
                ...
                <input type="date" name="tgl_sttp" class="form-control @error('tgl_sttp') is-invalid @enderror"
                    value="{{old('tgl_sttp')}}" id="tgl_sttp" aria-describedby="tgl_sttp" name="tgl_sttp">
                @error('tgl_sttp')
            ...
            <div class="input-group mb-3">
                <input type="file" name="sertifikat" required
                    class="form-control @error('sertifikat') is-invalid @enderror" value="{{old('sertifikat')}}"
                    id="sertifikat" accept=".pdf" name="sertifikat">

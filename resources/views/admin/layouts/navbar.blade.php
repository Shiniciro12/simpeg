<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#"> <img src="/images/logo.svg" width="15",height="15" alt="">
    SIMPEG Kota Kupang</a>
    <form action="" method="get" class="my-2 w-100">

    ...
    <div class="row">
        <div class="col-md-12 mx-auto">
            <div class="text-center my-3">
                <div class="h4">Daftar Pegawai</div>
            </div>
            <br>
            <div class="col-md-12">
                        ...
                        <tr>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <li><a class="dropdown-item"
                                                href="/admin/bkppd/berkas/umum/{{ $rowPegawai['verifikasi_id'] }}/{{ $rowPegawai['docx_id'] }}/pangkat">Pangkat</a>
                                        </li>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <li><a class="dropdown-item"
                                                href="/admin/bkppd/berkas/khusus/{{ $rowPegawai['verifikasi_id'] }}/{{ $rowPegawai['docx_id'] }}/drh">DRH</a>
                                        </li>

                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row['nip'] }}</td>
                                    <td>{{ $row['nama'] }}</td>
                                    <td><a class="btn btn-primary btn-sm" href="{{ $row['sttb'] }}">Lihat
                                            Dokumen</a></td>
                                    <td><a class="btn btn-primary btn-sm" href="{{ $row['transkrip'] }}">Lihat
                                            Dokumen</a></td>
                                    <td>
                                        ...
                                        <form action="/admin/unit-kerja/berkas/verifikasi" method="post">
                                            ...
                                            <input type="hidden" name="dokumen" value="pendidikan">

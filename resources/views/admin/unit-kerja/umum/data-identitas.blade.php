                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Berkala Terakhir</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row['nip'] }}</td>
                                    <td>{{ $row['nama'] }}</td>
                                    <td><img width="100" height="100" src="{{ $row['foto'] }}">
                                    </td>
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="{{ $row['karpeg'] }}">
                                            Lihat Dokumen</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="{{ $row['berkala_terakhir'] }}">
                                            Lihat Dokumen</a>
                                    </td>
                                    <td>
                                        ...
                                        <form action="/admin/unit-kerja/berkas/verifikasi" method="post">
                                            ...
                                            <input type="hidden" name="dokumen" value="identitas">

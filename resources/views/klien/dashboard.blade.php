                                        ...
                                        <div class="col-sm-4">
                                            <div class="card">
                                                <div class="card-body text-center">
                                                    ...
                                                    <img src="{{ auth()->user()->foto }}" class="rounded" width="100%"
                                                        alt="">
                                                    @else
                                                            ...
                                                            <form action="/klien/dataumum/identitas/ganti-gambar"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <small>*Format: .jpg, .jpeg, .png ukuran
                                                                            500Kb</small>
                                                                    </div>
                                                                </div>
                                                        </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <a href="/klien/dataumum/identitas/edit" class="btn btn-primary"><i
                                                            class="fa fa-sticky-note"></i>
                                                        Lengkapi Data Identitas</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

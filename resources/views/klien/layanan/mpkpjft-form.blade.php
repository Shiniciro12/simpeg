    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
          <h1 class="h2">Mutasi Pelayanan Kenaikan Pangkat Jabatan Fungsional Tertentu</h1>
        </div>  
        <div class="row">
          <div class="col-md-10 mx-auto">
            <form action="/klien/layanan/mpkpjftadd" method="POST" enctype="multipart/form-data">
              @csrf
              {{-- Jenis Layanan --}}
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="mb-3">
                          <label for="formFile" class="form-label">FC STLUD TK II atau Sertifikat Diklat PIM III Bagi Yang Pindah Golongan II/d ke IV/a, Kecuali Memiliki Ijazah Dokter, Apoteker dan Magister (S2)</label>
                      ...
                      <div class="col-sm-6">
                        <div class="mb-3">
                          ...
                          <input class="form-control @error('fcskps') is-invalid @enderror" type="file" name="fcskps" id="fcskps" accept=".pdf">
                          @error('fcskps')
                          <div id="fcskps" class="invalid-feedback">
                            {{$message}}
                          </div>
                          @enderror
                        </div>

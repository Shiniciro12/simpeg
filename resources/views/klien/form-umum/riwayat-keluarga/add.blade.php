                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-block">
                                                                ...
                                                                <input type="hidden" value="{{ auth()->user()->nip }}"
                                                                    name="nip_orang_tua">
                                                                <input type="hidden" value="0" name="ket_orang_tua">
                                                                <input type="hidden" value="Orang Tua"
                                                                    name="status_keluarga_orang_tua">

                                                                <div class="form-group form-default">
                                                                    <input type="number" name="nik_orang_tua"
                                                                        class="form-control @error('nik_orang_tua') is-invalid @enderror"
                                                                        value="{{old('nik_orang_tua')}}"
                                                                        id="nik_orang_tua"
                                                                        aria-describedby="nik_orang_tua">
                                                                    @error('nik_orang_tua')
                                                                ...
                                                                <div class="form-group form-default">
                                                                    <input type="text" name="nama_orang_tua"
                                                                        ...
                                                                        id="nama_orang_tua"
                                                                        aria-describedby="nama_orang_tua">
                                                                ...
                                                                <br>
                                                                <div class="form-group form-default">
                                                                    <input type="text" name="tempat_lahir_orang_tua"
                                                                        class="form-control @error('tempat_lahir_orang_tua') is-invalid @enderror"
                                                                        value="{{old('tempat_lahir_orang_tua')}}"
                                                                        id="tempat_lahir_orang_tua"
                                                                        aria-describedby="tempat_lahir_orang_tua">
                                                                    @error('tempat_lahir_orang_tua')
                                                                    <div id="tempat_lahir_orang_tua"
                                                                        class="text-danger">
                                                                        {{$message}}
                                                                    </div>
                                                                    @enderror
                                                                ...
                                                                <br>
                                                                <div class="form-group form-default">
                                                                    <input type="date" name="tgl_lahir_orang_tua"
                                                                        class="form-control @error('tgl_lahir_orang_tua') is-invalid @enderror"
                                                                        value="{{old('tgl_lahir_orang_tua')}}"
                                                                        id="tgl_lahir_orang_tua"
                                                                        aria-describedby="tgl_lahir_orang_tua">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <select
                                                                            class="form-control @error('jenis_kelamin_orang_tua') is-invalid @enderror"
                                                                            name="jenis_kelamin_orang_tua"
                                                                            value="{{old('jenis_kelamin_orang_tua')}}"
                                                                            aria-label="jenis kelamin"
                                                                            id="jenis_kelamin_orang_tua">
                                                                            <option selected value="">Pilih Jenis
                                                                                Kelamin</option>
                                                                            <option
                                                                                {{old('jenis_kelamin_orang_tua')=='L'
                                                                                ? 'selected' : '' }} value="L">Laki-laki
                                                                            </option>
                                                                            <option
                                                                                {{old('jenis_kelamin_orang_tua')=='P'
                                                                                ? 'selected' : '' }} value="P">Perempuan
                                                                            </option>
                                                                        </select>
                                                                        @error('jenis_kelamin_orang_tua')
                                                                        <div id="jenis_kelamin_orang_tua"
                                                                            class="text-danger">
                                                                            {{$message}}
                                                                        </div>
                                                                        @enderror
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <select
                                                                            class="form-control @error('status_kawin_orang_tua') is-invalid @enderror"
                                                                            name="status_kawin_orang_tua"
                                                                            value="{{old('status_kawin_orang_tua')}}"
                                                                            aria-label="status kawin"
                                                                            id="status_kawin_orang_tua">
                                                                            <option selected value="">Pilih Status
                                                                                Perkawinan</option>
                                                                            <option
                                                                                {{old('status_kawin_orang_tua')=='Belum Kawin'
                                                                                ? 'selected' : '' }}
                                                                                value="Belum Kawin">Belum Kawin
                                                                            </option>
                                                                            <option
                                                                                {{old('status_kawin_orang_tua')=='Kawin'
                                                                                ? 'selected' : '' }} value="Kawin">Kawin
                                                                            </option>
                                                                            <option
                                                                                {{old('status_kawin_orang_tua')=='Janda'
                                                                                ? 'selected' : '' }} value="Janda">Janda
                                                                            </option>
                                                                            <option
                                                                                {{old('status_kawin_orang_tua')=='Duda'
                                                                                ? 'selected' : '' }} value="Duda">Duda
                                                                            </option>
                                                                        </select>
                                                                        @error('status_kawin_orang_tua')
                                                                        <div id="status_kawin_orang_tua"
                                                                            class="text-danger">
                                                                            {{$message}}
                                                                        </div>
                                                                        @enderror
                                                                ...
                                                                <div class="form-group form-default">
                                                                    <input type="date" name="tgl_kawin_orang_tua"
                                                                        class="form-control @error('tgl_kawin_orang_tua') is-invalid @enderror"
                                                                        value="{{old('tgl_kawin_orang_tua')}}"
                                                                        id="tgl_kawin_orang_tua"
                                                                        aria-describedby="tgl_kawin_orang_tua">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <select
                                                                            class="form-control @error('status_tunjangan_orang_tua') is-invalid @enderror"
                                                                            name="status_tunjangan_orang_tua"
                                                                            value="{{old('status_tunjangan_orang_tua')}}"
                                                                            aria-label="status_tunjangan_orang_tua"
                                                                            id="status_tunjangan_orang_tua">
                                                                            <option selected value="">Pilih Status
                                                                                Tunjangan</option>
                                                                            <option
                                                                                {{old('status_tunjangan_orang_tua')=='Ya'
                                                                                ? 'selected' : '' }} value="Ya">Ya
                                                                            </option>
                                                                            <option
                                                                                {{old('status_tunjangan_orang_tua')=='Tidak'
                                                                                ? 'selected' : '' }} value="Tidak">Tidak
                                                                            </option>
                                                                        </select>
                                                                        @error('status_tunjangan_orang_tua')
                                                                        <div id="status_tunjangan_orang_tua"
                                                                            class="text-danger">
                                                                            {{$message}}
                                                                        </div>
                                                                        @enderror
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <select
                                                                            class="form-control @error('pendidikan_orang_tua') is-invalid @enderror"
                                                                            name="pendidikan_orang_tua"
                                                                            value="{{old('pendidikan_orang_tua')}}"
                                                                            aria-label="pendidikan_orang_tua"
                                                                            id="pendidikan_orang_tua">
                                                                            <option selected value="">Pilih Status
                                                                                Pendidikan Orang Tua</option>
                                                                            <option
                                                                                {{old('pendidikan_orang_tua')=='Belum Sekolah'
                                                                                ? 'selected' : '' }}
                                                                                value="Belum Sekolah">Belum Sekolah
                                                                            </option>
                                                                            <option
                                                                                {{old('pendidikan_orang_tua')=='TK/Paud'
                                                                                ? 'selected' : '' }} value="TK/Paud">
                                                                                TK/Paud
                                                                            </option>
                                                                            <option
                                                                                {{old('pendidikan_orang_tua')=='SD Sederajat'
                                                                                ? 'selected' : '' }}
                                                                                value="SD Sederajat">SD Sederajat
                                                                            </option>
                                                                            <option
                                                                                {{old('pendidikan_orang_tua')=='SMP Sederajat'
                                                                                ? 'selected' : '' }}
                                                                                value="SMP Sederajat">SMP Sederajat
                                                                            </option>
                                                                            <option
                                                                                {{old('pendidikan_orang_tua')=='SMA Sederajat'
                                                                                ? 'selected' : '' }}
                                                                                value="SMA Sederajat">SMA Sederajat
                                                                            </option>
                                                                            <option
                                                                                {{old('pendidikan_orang_tua')=='S1(Sarjana)'
                                                                                ? 'selected' : '' }}
                                                                                value="S1(Sarjana)">S1(Sarjana)
                                                                            </option>
                                                                            <option
                                                                                {{old('pendidikan_orang_tua')=='S2(Master)'
                                                                                ? 'selected' : '' }} value="S2(Master)">
                                                                                S2(Master)
                                                                            </option>
                                                                            <option
                                                                                {{old('pendidikan_orang_tua')=='S3(Doctor)'
                                                                                ? 'selected' : '' }} value="S3(Doctor)">
                                                                                S3(Doctor)
                                                                            </option>
                                                                        </select>
                                                                        @error('pendidikan_orang_tua')
                                                                        <div id="pendidikan_orang_tua"
                                                                            class="text-danger">
                                                                            {{$message}}
                                                                        </div>
                                                                        @enderror
                                                                ...
                                                                <div class="form-group form-default">
                                                                    <input type="text"
                                                                        ...
                                                                        aria-describedby="pekerjaan_orang_tua">
                                                            ...
                                                            <div class="card-block">
                                                                ...
                                                                <div class="form-group form-default">
                                                                    <textarea
                                                                        ...
                                                                        rows="3">{{old('alamat_orang_tua')}}</textarea>
                                                                ...
                                                                <div class="form-group form-default">
                                                                    <input type="text"
                                                                        ...
                                                                        name="desa_kelurahan_orang_tua"
                                                                        value="{{old('desa_kelurahan_orang_tua')}}"
                                                                        id="desa_kelurahan_orang_tua"
                                                                        aria-describedby="desa_kelurahan_orang_tua">
                                                                    @error('desa_kelurahan_orang_tua')
                                                                    <div id="desa_kelurahan_orang_tua"
                                                                        class="text-danger">
                                                                        {{$message}}
                                                                    </div>
                                                                    @enderror
                                                                ...
                                                                <div class="form-group form-default">
                                                                    <input type="text"
                                                                        ...
                                                                        name="kecamatan_orang_tua"
                                                                        value="{{old('kecamatan_orang_tua')}}"
                                                                        id="kecamatan_orang_tua"
                                                                        aria-describedby="kecamatan_orang_tua">
                                                                ...
                                                                <div class="form-group form-default">
                                                                    <input type="text"
                                                                        ...
                                                                        name="kabupaten_kota_orang_tua"
                                                                        value="{{old('kabupaten_kota_orang_tua')}}"
                                                                        id="kabupaten_kota_orang_tua"
                                                                        aria-describedby="kabupaten_kota_orang_tua">
                                                                    @error('kabupaten_kota_orang_tua')
                                                                    <div id="kabupaten_kota_orang_tua"
                                                                        class="text-danger">
                                                                        {{$message}}
                                                                    </div>
                                                                    @enderror
                                                                ...
                                                                <div class="form-group form-default">
                                                                    <input type="text"
                                                                        ...
                                                                        name="provinsi_orang_tua"
                                                                        value="{{old('provinsi_orang_tua')}}"
                                                                        id="provinsi_orang_tua"
                                                                        aria-describedby="provinsi_orang_tua">
                                                                ...
                                                                <div class="form-group form-default">
                                                                    <input type="number"
                                                                        ...
                                                                        name="hp_orang_tua"
                                                                        value="{{old('hp_orang_tua')}}"
                                                                        id="hp_orang_tua"
                                                                        aria-describedby="hp_orang_tua">
                                                                    @error('hp_orang_tua')
                                                                ...
                                                                <div class="form-group form-default">
                                                                    <input type="number"
                                                                        ...
                                                                        name="kode_pos_orang_tua"
                                                                        value="{{old('kode_pos_orang_tua')}}"
                                                                        id="kode_pos_orang_tua"
                                                                        aria-describedby="kode_pos_orang_tua">
                                                                ...
                                                                <br>
                                                                <div class="form-group row">
                                                                    <label class="col-sm-6 col-form-label">File KK
                                                                        (Format Pdf Maksimal 500kb)
                                                                        <span class="text-danger">*</span></label><br>
                                                                    <div class="col-sm-12">
                                                                        <input type="file"
                                                                            class="form-control @error('dokumen_orang_tua') is-invalid @enderror"
                                                                            value="{{old('dokumen_orang_tua')}}"
                                                                            id="dokumen_orang_tua"
                                                                            name="dokumen_orang_tua">
            ...
            <div class="pcoded-inner-content">
                ...
                <div class="main-body">
                    <div class="page-wrapper">
                        ...
                        <div class="page-body">
                            {{-- Table taro sini --}}
                            <form action="/klien/dataumum/keluarga/store" method="post" enctype="multipart/form-data"
                                class="form-material">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Form Tambah Pasangan</h5>
                                            </div>
                                            {{-- ISIAN FORM --}}
                                            <div class="card-block">
                                                @csrf
                                                ...
                                                <input type="hidden" value="Pasangan" name="status_keluarga_pasangan">

                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <select
                                                            class="form-control @error('ket_pasangan') is-invalid @enderror"
                                                            ...
                                                            <option {{old('ket_pasangan')=='3' ? 'selected' : '' }}
                                                                value="3">3
                                                            </option>
                                                            <option {{old('ket_pasangan')=='4' ? 'selected' : '' }}
                                                                value="4">4
                                                            </option>
                                                            <option {{old('ket_pasangan')=='5' ? 'selected' : '' }}
                                                                value="5">5
                                                            </option>
                                                            </option>
                                                            <option {{old('ket_pasangan')=='6' ? 'selected' : '' }}
                                                                value="6">6
                                                            </option>
                                                            </option>
                                                            <option {{old('ket_pasangan')=='7' ? 'selected' : '' }}
                                                                value="7">7
                                                            </option>
                                                            </option>
                                                            <option {{old('ket_pasangan')=='8' ? 'selected' : '' }}
                                                                value="8">8
                                                            </option>
                                                            </option>
                                                            <option {{old('ket_pasangan')=='9' ? 'selected' : '' }}
                                                                value="9">9
                                                            </option>
                                                            </option>
                                                            <option {{old('ket_pasangan')=='10' ? 'selected' : '' }}
                                                                value="10">10
                                                            </option>
                                                        </select>
                                                        @error('ket')
                                                ...
                                                <br>
                                                <div class="form-group form-default">
                                                    <input type="number" name="nik_pasangan"
                                                        class="form-control @error('nik_pasangan') is-invalid @enderror"
                                                        value="{{old('nik_pasangan')}}" id="nik_pasangan"
                                                        aria-describedby="nik_pasangan">
                                                    @error('nik_pasangan')
                                                ...
                                                <div class="form-group form-default">
                                                    <input type="text" name="nama_pasangan"
                                                        ...
                                                        value="{{old('nama_pasangan')}}" id="nama_pasangan"
                                                        aria-describedby="nama_pasangan">
                                                    @error('nama_pasangan')
                                                ...
                                                <div class="form-group form-default">
                                                    <input type="text" name="tempat_lahir_pasangan"
                                                        ...
                                                        aria-describedby="tempat_lahir_pasangan">
                                                ...
                                                <div class="form-group form-default">
                                                    <input type="date" name="tgl_lahir_pasangan"
                                                        ...
                                                        value="{{old('tgl_lahir_pasangan')}}" id="tgl_lahir_pasangan"
                                                        aria-describedby="tgl_lahir_pasangan">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <select
                                                            class="form-control @error('jenis_kelamin_pasangan') is-invalid @enderror"
                                                            name="jenis_kelamin_pasangan"
                                                            value="{{old('jenis_kelamin_pasangan')}}"
                                                            aria-label="jenis kelamin" id="jenis_kelamin_pasangan">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <select
                                                            class="form-control @error('status_kawin_pasangan') is-invalid @enderror"
                                                            name="status_kawin_pasangan"
                                                            value="{{old('status_kawin_pasangan')}}"
                                                            aria-label="status kawin" id="status_kawin_pasangan">
                                                            <option selected value="">Pilih Status Perkawinan</option>
                                                            <option {{old('status_kawin_pasangan')=='Belum Kawin'
                                                                ? 'selected' : '' }} value="Belum Kawin">Belum Kawin
                                                            </option>
                                                ...
                                                <br>
                                                <div class="form-group form-default">
                                                    <input type="date" name="tgl_kawin_pasangan"
                                                        class="form-control @error('tgl_kawin_pasangan') is-invalid @enderror"
                                                        value="{{old('tgl_kawin_pasangan')}}" id="tgl_kawin_pasangan"
                                                        aria-describedby="tgl_kawin_pasangan">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <select
                                                            class="form-control @error('status_tunjangan_pasangan') is-invalid @enderror"
                                                            name="status_tunjangan_pasangan"
                                                            value="{{old('status_tunjangan_pasangan')}}"
                                                            aria-label="status_tunjangan_pasangan"
                                                            id="status_tunjangan_pasangan">
                                                            <option selected value="">Pilih Status Tunjangan</option>
                                                            <option {{old('status_tunjangan_pasangan')=='Ya'
                                                                ? 'selected' : '' }} value="Ya">Ya
                                                            </option>
                                                            <option {{old('status_tunjangan_pasangan')=='Tidak'
                                                                ? 'selected' : '' }} value="Tidak">Tidak
                                                            </option>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <select
                                                            class="form-control @error('pendidikan_pasangan') is-invalid @enderror"
                                                            ...
                                                            <option {{old('pendidikan_pasangan')=='Belum Sekolah'
                                                                ? 'selected' : '' }} value="Belum Sekolah">Belum Sekolah
                                                            </option>
                                                            <option {{old('pendidikan_pasangan')=='TK/Paud' ? 'selected'
                                                                : '' }} value="TK/Paud">TK/Paud
                                                            </option>
                                                            <option {{old('pendidikan_pasangan')=='SD Sederajat'
                                                                ? 'selected' : '' }} value="SD Sederajat">SD Sederajat
                                                            </option>
                                                            <option {{old('pendidikan_pasangan')=='SMP Sederajat'
                                                                ? 'selected' : '' }} value="SMP Sederajat">SMP Sederajat
                                                            </option>
                                                            <option {{old('pendidikan_pasangan')=='SMA Sederajat'
                                                                ? 'selected' : '' }} value="SMA Sederajat">SMA Sederajat
                                                            </option>
                                                            <option {{old('pendidikan_pasangan')=='S1(Sarjana)'
                                                                ? 'selected' : '' }} value="S1(Sarjana)">S1(Sarjana)
                                                            </option>
                                                            <option {{old('pendidikan_pasangan')=='S2(Master)'
                                                                ? 'selected' : '' }} value="S2(Master)">S2(Master)
                                                            </option>
                                                            <option {{old('pendidikan_pasangan')=='S3(Doctor)'
                                                                ? 'selected' : '' }} value="S3(Doctor)">S3(Doctor)
                                                            </option>
                                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                ...
                                                <div class="form-group form-default">
                                                    <textarea
                                                        class="form-control @error('alamat_pasangan') is-invalid @enderror"
                                                        value="{{old('alamat_pasangan')}}" name="alamat_pasangan"
                                                        id="alamat_pasangan"
                                                        rows="3">{{old('alamat_pasangan')}}</textarea>
                                                ...
                                                <div class="form-group form-default">
                                                    <input type="text"
                                                        ...
                                                        name="desa_kelurahan_pasangan"
                                                        value="{{old('desa_kelurahan_pasangan')}}"
                                                        id="desa_kelurahan_pasangan"
                                                        aria-describedby="desa_kelurahan_pasangan">
                                                ...
                                                <div class="form-group form-default">
                                                    <input type="text"
                                                        ...
                                                        name="kabupaten_kota_pasangan"
                                                        value="{{old('kabupaten_kota_pasangan')}}"
                                                        id="kabupaten_kota_pasangan"
                                                        aria-describedby="kabupaten_kota_pasangan">
                                                ...
                                                <br>
                                                <div class="form-group form-default">
                                                    <input type="number" name="telepon_pasangan"
                                                        class="form-control @error('telepon_pasangan') is-invalid @enderror"
                                                        value="{{old('telepon_pasangan')}}" id="telepon_pasangan"
                                                        aria-describedby="telepon_pasangan">
                                                ...
                                                <br>
                                                <div class="form-group row">
                                                    <label class="col-sm-6 col-form-label">File Akta Nikah (Format
                                                        Pdf
                                                        Maksimal 500kb)
                                                        <span class="text-danger">*</span></label><br>
                                                    <div class="col-sm-1_pasangan">
                                                        <input type="file"
                                                            class="form-control @error('dokumen_pasangan') is-invalid @enderror"
                                                            value="{{old('dokumen_pasangan')}}" id="dokumen_pasangan"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        @csrf
                                        <input type="hidden" value="{{ auth()->user()->nip }}" name="nip_anak">
                                        <input type="hidden" value="Anak" name="status_keluarga_anak">

                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <select class="form-control @error('ket_anak') is-invalid @enderror"
                                                    name="ket_anak" value="{{old('ket_anak')}}" aria-label="ket_anak"
                                                    id="ket_anak">
                                                    <option selected value="">Anak Ke- </option>
                                                    <option {{old('ket_anak')=='1' ? 'selected' : '' }} value="1">1
                                                    </option>
                                                    <option {{old('ket_anak')=='2' ? 'selected' : '' }} value="2">2
                                                    </option>
                                                    <option {{old('ket_anak')=='3' ? 'selected' : '' }} value="3">3
                                                    </option>
                                                    <option {{old('ket_anak')=='4' ? 'selected' : '' }} value="4">4
                                                    </option>
                                                    <option {{old('ket_anak')=='5' ? 'selected' : '' }} value="5">5
                                                    </option>
                                                    </option>
                                                    <option {{old('ket_anak')=='6' ? 'selected' : '' }} value="6">6
                                                    </option>
                                                    </option>
                                                    <option {{old('ket_anak')=='7' ? 'selected' : '' }} value="7">7
                                                    </option>
                                                    </option>
                                                    <option {{old('ket_anak')=='8' ? 'selected' : '' }} value="8">8
                                                    </option>
                                                    </option>
                                                    <option {{old('ket_anak')=='9' ? 'selected' : '' }} value="9">9
                                                    </option>
                                                    </option>
                                                    <option {{old('ket_anak')=='10' ? 'selected' : '' }} value="10">10
                                                    </option>
                                                </select>
                                                @error('ket_anak')
                                        ...
                                        <div class="form-group form-default">
                                            <input type="text" name="nama_anak"
                                                ...
                                                value="{{old('nama_anak')}}" id="nama_anak"
                                                aria-describedby="nama_anak">
                                            @error('nama_anak')
                                        ...
                                        <div class="form-group form-default">
                                            <input type="text" name="tempat_lahir_anak"
                                                ...
                                                value="{{old('tempat_lahir_anak')}}" id="tempat_lahir_anak"
                                                aria-describedby="tempat_lahir_anak">
                                        ...
                                        <div class="form-group form-default">
                                            <input type="date" name="tgl_lahir_anak"
                                                ...
                                                value="{{old('tgl_lahir_anak')}}" id="tgl_lahir_anak"
                                                aria-describedby="tgl_lahir_anak">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <select
                                                    ...
                                                    name="jenis_kelamin_anak" value="{{old('jenis_kelamin_anak')}}"
                                                    aria-label="jenis kelamin" id="jenis_kelamin_anak">
                                                    <option selected value="">Pilih Jenis Kelamin</option>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <select
                                                    class="form-control @error('status_kawin_anak') is-invalid @enderror"
                                        ...
                                        <br>
                                        <div class="form-group form-default">
                                            <input type="date" name="tgl_kawin_anak"
                                                class="form-control @error('tgl_kawin_anak') is-invalid @enderror"
                                                value="{{old('tgl_kawin_anak')}}" id="tgl_kawin_anak"
                                                aria-describedby="tgl_kawin_anak">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <select
                                                    class="form-control @error('status_tunjangan_anak') is-invalid @enderror"
                                                    name="status_tunjangan_anak"
                                                    value="{{old('status_tunjangan_anak')}}"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <select
                                                    class="form-control @error('pendidikan_anak') is-invalid @enderror"
                                                    name="pendidikan_anak" value="{{old('pendidikan_anak')}}"
                                                    aria-label="pendidikan_anak" id="pendidikan_anak">
                                                    <option selected value="">Pilih Status Pendidikan Anak
                                                    </option>
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="form-group form-default">
                                            <textarea class="form-control @error('alamat_anak') is-invalid @enderror"
                                                value="{{old('alamat_anak')}}" name="alamat_anak" id="alamat_anak"
                                                rows="3">{{old('alamat_anak')}}</textarea>
                                            @error('alamat_anak')
                                        ...
                                        <div class="form-group form-default">
                                            <input type="text"
                                                ...
                                                name="provinsi_anak" value="{{old('provinsi_anak')}}" id="provinsi_anak"
                                                aria-describedby="provinsi_anak">
                                            @error('provinsi_anak')
                                            <div id="" class="text-danger">
                                                {{$message}}
                                            </div>
                                        ...
                                        <div class="form-group form-default">
                                            <input type="number"
                                                ...
                                                name="hp_anak" value="{{old('hp_anak')}}" id="hp_anak"
                                                aria-describedby="hp_anak">
                                            @error('hp_anak')
                                        ...
                                        <br>
                                        <div class="form-group form-default">
                                            <input type="number" name="telepon_anak"
                                                class="form-control @error('telepon_anak') is-invalid @enderror"
                                                value="{{old('telepon_anak')}}" id="telepon_anak"
                                                aria-describedby="telepon_anak">
                                            @error('telepon_anak')
                                        ...
                                        <div class="form-group form-default">
                                            <input type="number"
                                                ...
                                                name="kode_pos_anak" value="{{old('kode_pos_anak')}}" id="kode_pos_anak"
                                                aria-describedby="kode_pos_anak">
                                            @error('kode_pos_anak')
                                        ...
                                        <br>
                                        <div class="form-group row">
                                            <label class="col-sm-6 col-form-label">File Akta Kelahiran (Format
                                                Pdf
                                                Maksimal 500kb)
                                                <span class="text-danger">*</span></label><br>
                                            <div class="col-sm-12">
                                                <input type="file"
                                                    class="form-control @error('dokumen_anak') is-invalid @enderror"
                                                    value="{{old('dokumen_anak')}}" id="dokumen_anak"
                                                    name="dokumen_anak">
                                                @error('dokumen_anak')

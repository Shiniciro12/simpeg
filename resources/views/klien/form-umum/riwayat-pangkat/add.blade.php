    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <form action="/klien/dataumum/riwayat-pangkat/store" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <label for="sk_pangkat" class="form-label">File SK (Fotmat Pdf Maksimal 500kb) <span class="text-danger">*</span></label>

                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="page-header-title">
                            <h1 class="m-b-10" style="color:white">Diklat</h1>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <form action="/klien/dataumum/diklat/store" method="post" class="form-material" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                <select class="form-control @error('status') is-invalid @enderror" value="{{old('status')}}" name="status" aria-label="status" id="status">
                                            ...
                                            @enderror
                                            <span class="form-bar"></span>
                                                <label class="float-label">Nama Diklat <span class="text-danger">*</span></label>
                                            </div>
                                            <br>
                                            <div class="form-group form-default">
                                            ...
                                            @enderror
                                            <span class="form-bar"></span>
                                                <label class="float-label">Tempat Diklat <span class="text-danger">*</span></label>
                                            </div>
                                            <br>
                                            <div class="form-group form-default">
                                            ...
                                            @enderror
                                                <span class="form-bar"></span>
                                                <label class="float-label">Penyelenggara <span class="text-danger">*</span></label>
                                            </div>
                                            <br>
                                            <div class="form-group form-default">
                                            ...
                                            @enderror
                                                <span class="form-bar"></span>
                                                <label class="float-label">Tanggal Mulai <span class="text-danger">*</span></label>
                                            </div>
                                            <br>
                                            <div class="form-group form-default">
                                            ...
                                            @enderror
                                                <span class="form-bar"></span>
                                                <label class="float-label">Tanggal Selesai <span class="text-danger">*</span></label>
                                            </div>
                                            <br>
                                            <div class="form-group form-default">
                                            ...
                                            @enderror
                                                <span class="form-bar"></span>
                                                <label class="float-label">Nomor Sertifikat <span class="text-danger">*</span></label>
                                            </div>
                                            <br>
                                            <div class="form-group form-default">
                                            ...
                                            @enderror
                                                <span class="form-bar"></span>
                                                <label class="float-label">Tanggal Sertifikat<span class="text-danger">*</span></label>
                                            </div>
                                            <br>
                                            <div class="form-group row">
                                                <label class="col-sm-6 col-form-label">File Sertifikat (Fotmat Pdf Maksimal 500kb)
                                                    <span class="text-danger">*</span></label><br>
                                                <div class="col-sm-12">
                                                <input type="file" name="sertifikat" class="form-control @error('sertifikat') is-invalid @enderror" value="{{old('sertifikat')}}" id="sertifikat" accept=".pdf" name="sertifikat">
                                                @error('sertifikat')

                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form action="/klien/dataumum/riwayat-jabatan/store" method="post" enctype="multipart/form-data" class="form-material">
                                        @csrf
                                        <input type="hidden" value="{{auth()->user()->identitas_id}}" name="identitas_id">
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <select class="form-control unitKerja" name="unitKerja" id="unitKerjaId" required>

                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{$rowJabatan['nama_jabatan']}}" id="nama"
                                aria-describedby="nama" name="nama">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-3">
                            <label for="eselon" class="form-label">Eselon/Kelas <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" value="{{$rowJabatan['eselon']}}" id="eselon"
                                aria-describedby="eselon" name="eselon">
                        </div>
                    </div>
                </div>
                <div class="row">

                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_jabatan') is-invalid @enderror"
                                value="{{old('nama_jabatan', $rowJabatan['nama_jabatan'])}}" id="nama_jabatan"
                                aria-describedby="nama_jabatan" name="nama_jabatan">
                            @error('nama_jabatan')
                    ...
                    <div class="col-sm-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('eselon') is-invalid @enderror"
                                value="{{old('eselon', $rowJabatan['eselon'])}}" id="eselon" aria-describedby="eselon"
                                name="eselon">
                            @error('eselon')
                    ...
                    <div class="col-sm-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kelas') is-invalid @enderror"
                                value="{{old('kelas', $rowJabatan['kelas'])}}" id="kelas" aria-describedby="kelas"
                                name="kelas">
                            @error('kelas')
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="unit_kerja" name="unit_kerja_id" id="unit_kerja_id">
                                ...
                                <option value="{{ $rowUniteKerja['unit_kerja_id'] }}" <?php if
                                    ($rowJabatan['unit_kerja_id']==$rowUniteKerja['unit_kerja_id']) { echo "selected " ;

...
class KeluargaController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        $newFile =  $id_identitas['identitas_id'] . "-keluarga-" . time() .  "." . $extension;
    ...
    public function UmumView()
    {
        return view('klien.form-umum.riwayat-keluarga.index', [
            'page' => 'Data Keluarga',
            "rows" => Keluarga::select('keluarga.*')->join('identitas', 'identitas.identitas_id', '=', 'keluarga.identitas_id')->latest()->where('keluarga.identitas_id', '=', auth()->user()->identitas_id)->filter(request(['search']))->paginate(10)->withQueryString(),
        ]);
    }
    ...
    public function UStore(Request $request)
    {
        ...
        if ($request->input('status_keluarga_orang_tua') == 'Orang Tua') {
            ...
            $newFile =  $id_identitas['identitas_id'] . "-keluarga-ortu-" . time() .  "." . $extension;
            ...
            $newFile =  $id_identitas['identitas_id'] . "-keluarga-pasangan-" . time() .  "." . $extension;
            ...
            $newFile =  $id_identitas['identitas_id'] . "-keluarga-anak-" . time() .  "." . $extension;

...
class PendidikanController extends Controller
{
    ...
    {
        $id_identitas = Identitas::where('identitas_id', $request->input('identitas_id'))->first();
        ...
        $temp1 = $request->file('transkrip')->getPathName();
        $file1 = $id_identitas['identitas_id'] . "-transkrip-" . date('s');

        $folder = "unggah/sttb/" . $file . ".pdf";
        move_uploaded_file($temp, $folder);

        $folder1 = "unggah/transkrip/" . $file1 . ".pdf";
        move_uploaded_file($temp1, $folder1);

        $name = $id_identitas['identitas_id'] . "-sttb-"  . date('s');
        $name1 = $id_identitas['identitas_id'] . "-transkrip-"  . date('s');

    ...
    public function run()
    {
        for ($i = 1; $i < 5; $i++) {
            Identitas::create([
                ...
                'golongan_darah' => 'AB',
                'foto' => "/unggah/identitas/foto/default.jpg",
                'no_karpeg' => '123456789' . $i,
                'karpeg' => '/unggah/identitas/karpeg/123456789' . $i . '.pdf',
                'berkala_terakhir' => '/unggah/identitas/berkala-terakhir/123456789' . $i . '.pdf',
